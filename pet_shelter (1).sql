...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2026 at 07:26 PM
...
(1, 1, 'West Shewrapara,Mirpur,Dhaka', 'Student', NULL),
(2, 2, 'Mirpur-12, Dhaka', 'Doctor', NULL),
(3, 3, 'Mirpur-12, Dhaka', 'Musician', 'Apartment'),
(4, 4, 'Mirpur-11,Dhaka', 'Engineer', 'Family House'),
(5, 11, 'Dhanmondi, House-11, Road-4', 'Teacher', 'Family House'),
(6, 13, 'Dhanmondi', 'Student', 'Apartment');
...
INSERT INTO `adoption` (`adoption_id`, `application_id`, `adoption_date`, `adopter_id`, `approved_by`) VALUES
(1, 1, '2026-04-09', 4, 1),
(2, 2, '2026-04-09', 3, 5),
(3, 3, '2026-04-09', 6, 1);
...
INSERT INTO `adoption_applications` (`application_id`, `adopter_id`, `pet_id`, `application_date`, `status`) VALUES
(1, 4, 5, '2026-04-09', 'Approved'),
(2, 3, 12, '2026-04-09', 'Approved'),
(3, 6, 11, '2026-04-09', 'Approved');
...
INSERT INTO `donations` (`donation_id`, `donor_name`, `amount`, `donation_date`, `shelter_id`) VALUES
(1, 'Tom Aaron', 3000.00, '2026-04-08', 1),
(2, 'John Smith\r\n', 3000.00, '2026-04-08', 2),
(3, 'Alice Ren', 5000.00, '2026-04-08', 6),
(4, 'Solomon Khan', 2000.00, '2026-04-08', 5),
(5, 'Lia Kim', 4000.00, '2026-04-09', 6),
(6, 'Bella John', 6000.00, '2026-04-09', 3);
...
INSERT INTO `inventory` (`item_id`, `item_name`, `quantity`, `shelter_id`) VALUES
(1, 'Dog Food', 20, 1),
(2, 'Cat Food', 15, 1),
(3, 'Pet Shampoo', 8, 1),
(4, 'Dog Food', 12, 2),
...
INSERT INTO `medical_records` (`record_id`, `pet_id`, `diagnosis`, `treatment`, `visit_date`) VALUES
(1, 2, 'Vaccination', 'Vaccination', '2026-03-19'),
(2, 6, 'Fever', 'Medication', '2026-03-27'),
(3, 7, 'Vaccination', 'Vaccination', '2026-03-28'),
(4, 8, 'Vaccination', 'Vaccination', '2026-04-09'),
(5, 5, 'Flea', 'Skin Testing', '2026-04-14');
...
INSERT INTO `payment` (`payment_id`, `adopter_id`, `amount`, `payment_date`, `payment_method`) VALUES
(1, 4, 4000.00, '2026-04-09', 'Cash'),
(2, 3, 8000.00, '2026-04-09', 'Credit Card'),
(3, 6, 5000.00, '2026-04-09', 'bKash');
...
(5, 'Max', 3, 'Male', 'Orange', '2026-02-14', 'Adopted', 2, 3, 2),
(6, 'Bunny', 2, 'Female', 'White', '2026-03-27', 'Available', 4, 5, 3),
(7, 'Birdy', 1, 'Male', 'Green', '2026-03-27', 'Available', 5, 6, 4),
(8, 'Mari', 2, 'Male', 'White', '2026-03-20', 'Available', 1, 7, 2),
(10, 'Mark', 3, 'Male', 'Black', '2025-01-26', 'Available', 1, 7, 2),
(11, 'Mochi', 3, 'Female', 'Orange', '2025-01-26', 'Adopted', 3, 7, 2),
(12, 'Tom', 4, 'Male', 'Golden', '2026-04-01', 'Adopted', 3, 9, 1);
...
INSERT INTO `rescue_reports` (`report_id`, `pet_id`, `rescue_location`, `rescue_date`, `rescued_by`) VALUES
(1, 2, 'Dhaka', '2026-02-21', 1),
(2, 3, 'Chittagong', '2026-03-27', 5),
(3, 4, 'Sylhet', '2026-03-27', 2),
(4, 5, 'Rajshahi', '2026-02-14', 2),
(5, 6, 'Khulna', '2026-03-27', 3),
(6, 7, 'Barisal', '2026-03-01', 5),
(7, 10, 'Shewrapara, Mirpur', '2025-01-26', 4);
...
(4, 'Shelter 4', 'Rajshahi', 40, '01912001111'),
(5, 'Shelter 5', 'Khulna', 25, '01850002222'),
(6, 'Shelter 6', 'Barisal', 35, '01720003333');
...
(1, 6, 'Staff Manager', '2026-03-27'),
(2, 7, 'Trainer', '2026-03-31'),
(3, 8, 'Trainer', '2026-04-01'),
(4, 9, 'General Member ', '2026-04-01'),
(5, 10, 'General Member', '2026-04-02'),
(6, 12, 'Volunteer', '2026-04-08'),
(7, 14, 'General Member', '2026-04-09'),
(8, 15, 'General Member', '2026-04-09'),
(10, 16, 'Volunteer', '2026-04-09');
...
INSERT INTO `training_records` (`training_id`, `pet_id`, `trainer_name`, `training_type`, `completion_date`) VALUES
(1, 6, 'Trainer 1', 'Basic Training', '2026-04-21'),
(2, 5, 'Trainer 2', 'Obedience', '2026-04-20'),
(3, 4, 'Trainer 1', 'Food Training ', '2026-04-14'),
(4, 8, 'Afiha Ocean', 'Food Training', '2026-12-04');
...
(5, 'Admin User', 'admin@gmail.com', '0986754822', 'adminpassword', 'admin'),
(6, 'Staff User', 'staff@gmail.com', '098765411', 'staffpassword', 'staff'),
(7, 'Trainer 1', 'trainer1@gmail.com', '1234567890', 'trainerpassword1', 'staff'),
(8, 'Trainer 2', 'trainer2@gmail.com', '0987654321', 'trainerpassword2', 'staff'),
(9, 'Kevin Moon', 'kevin123@gmail.com', '0987645410', 'passwordkevin', 'staff'),
(10, 'Jacob Bae', 'jacob111@gmail.com', '1234567109', 'passwordjacob', 'staff'),
(11, 'Lia Rose', 'lia@gmail.com\r\n', '019225678', 'liapassword', 'adopter'),
(12, 'Jae Park', 'jae@gmail.com', '01233456', 'jaepassword', 'staff'),
(13, 'Peter Singer', 'singer@gmail.com', '018977765', '1233', 'adopter'),
(14, 'Afiha Ocean', 'ocean@gmail.com', '0184489567', 'afihapassword', 'staff'),
(15, 'Adib Khan', 'khan@gmail.com', '018456726', '1244', 'staff'),
(16, 'Madison Joan', 'joan@gmail.com', '0186574322', '5667', 'staff');
...
INSERT INTO `vaccinations` (`vaccination_id`, `pet_id`, `vaccine_name`, `vaccination_date`, `next_due_date`) VALUES
(1, 2, 'Rabies', '2026-03-20', '2027-03-20'),
(2, 3, 'Distemper', '2026-03-22', '2027-03-22'),
(3, 4, 'Parvovirus', '2026-03-25', '2027-03-25'),
(4, 5, 'Rabies', '2026-02-15', '2027-02-15'),
(5, 6, 'Feline Leukemia', '2026-03-27', '2027-03-27'),
(6, 7, 'Bird Flu', '2026-03-28', '2027-03-28'),
(7, 8, 'Rabies', '2026-04-09', '2027-04-09'),
(8, 8, 'FVRCP', '2026-04-09', '2027-04-09');
...
INSERT INTO `veterinarians` (`vet_id`, `name`, `phone`, `clinic_name`) VALUES
(1, 'Dr. Rahim Ahmed', '01711111111', 'Dhaka Pet Care'),
(2, 'Dr. Nusrat Jahan', '01822222222', 'Happy Paws Clinic'),
(3, 'Dr. Tanvir Hasan', '01933333333', 'Animal Health Center'),
(4, 'Dr. Samia Kabir', '01644444444', 'Pet Wellness Clinic');
...
--
ALTER TABLE `adoption`
  ADD CONSTRAINT `adoption_ibfk_1` FOREIGN KEY (`application_id`) REFERENCES `adoption_applications` (`application_id`),
  ADD CONSTRAINT `adoption_ibfk_2` FOREIGN KEY (`approved_by`) REFERENCES `staff` (`staff_id`),
  ADD CONSTRAINT `adoption_ibfk_3` FOREIGN KEY (`adopter_id`) REFERENCES `adopters` (`adopter_id`);
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`adopter_id`) REFERENCES `adopters` (`adopter_id`);
